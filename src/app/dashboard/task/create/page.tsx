        ...
        <div className="  text-2xl font-bold bg-white">
          <div className=" text-black ">
            Add Task
                ...
                <div className="flex flex-col w-[60%]">
                  ...
                  <div className="bg-slate-200 h-10 rounded-md flex items-center w-full text-sm">
                    <div
                      className={`h-8 ${
                        !isRecurral
                          ? "bg-[#2d62ed] shadow-lg text-white"
                          : "text-slate-800"
              ...
              <div className="mx-4 mt-2 flex gap-2 w-[58%]">
                <DateInput
                  label="Start Date"
              ...
              <div className="mt-8 m-4 w-[30%]">
                <Button
                  label="Submit"
                  className="hover:bg-[#1e42a0]"
                  onClick={submitTask}
                />
              </div>
            </div>
